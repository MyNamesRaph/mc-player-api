  ...
  async function deletePlayer() {
    try {
      const resp = await fetch(
        "http://localhost:8000/api/players/uuid/delete/" + uuid + "/" + apiKey,
        {
          method: "DELETE",
        },
      );
    ...
    <form class="m-10">
      <div class="mb-6">
        ...
        <Input
          ...
          class="w-full"
          id="UUID"
          placeholder="8c679f09-ef20-4599-84ea-1fbe33428169"
      ...
      <div class="mb-6">
        <label for="api-key" class="block mb-2 text-lg text-white">
          Clef d'api *
        </label>
        <Input
          type="text"
          class="w-full"
          id="api-key"
          placeholder="Entrez votre clef d'API..."
